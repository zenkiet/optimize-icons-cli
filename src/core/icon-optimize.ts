...
import { OptimizeIconsOptions, OptimizationStats, ProcessSvgResult } from './types';
...
export class IconOptimizer {
     ...
     */
    private updateStats(originalLength: number, optimizedLength: number, totalCount: number, removedCount: number): void {
